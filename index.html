                    ...
                    <fieldset class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="login-form">
                            <div class="form-group">
                                <label class="col-xs-12 text-center" for="usuario"><h4 style="font-size: 1.5em;">Usuario</h4></label>
                                <div class="col-xs-12">
                                    <input type="text" id="usuario" name="usuario" class="form-comtrol Imput" onkeypress="return soloEnterosPositivos(event);" maxlength="9" onblur="validarMaximo(this);">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12 text-center" for="password"><h4 style="font-size: 1.5em;">Password</h4></label>
                                <div class="col-xs-12">
                                    <input type="password" id="password" name="password" class="form-comtrol Imput" onfocus="validarCampoNumero();">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            $(document).ready(function() {
                $('#login-form').submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: { usuario: usuario, password: password }, // Envía los datos del formulario
                        success: function(response) {
                            if (response === 'success') {
                                window.location.href = 'bienvenido.html'; // Redirige al usuario si el inicio de sesión es exitoso
